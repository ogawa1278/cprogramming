// 	タイトル: 画像の圧縮
//
//	実装の方針: 実行時間にかなり余裕があったので複数の方法で圧縮し比較するようにした
//
//
//	工夫した点: できるだけ多くの設定を保存できるように範囲を分割した
//	            色は16*16の範囲の平均値または16*16の中の中心の8*8の平均値を12bitで保存し、さらに2つの三角形に分けて描画することでできるだけ大きな色の変化に対応できるようにした
//	            比較に関しては平均を取る範囲、三角の向き、そして色の合成のカーブの3つを変えて最も誤差の小さい組み合わせを選ぶ
//	            これらを圧縮すると5バイト余ったのでカーブの種類を増やすことができるがテストしてみると選ばれるカーブに偏りが大きく不要だと考えた
//
//
//
//	参考にした資料: なし
